...
function getBaseTotalBeforePromo() {
  ...
  const deliveryPrice = state.mode === "delivery" && typeof state.delivery.price === "number" ? state.delivery.price : 0;
...
function renderTotals() {
  ...
  const deliveryPrice = state.mode === "delivery" && typeof state.delivery.price === "number" ? state.delivery.price : 0;
  const baseTotal = subtotal + cutleryPrice + nightMarkup + deliveryPrice;
